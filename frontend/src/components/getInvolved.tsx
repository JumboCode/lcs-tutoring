    ...
    <div className="bg-[#FBFAFC] p-12 md:p-24">
      <div className="max-w-6xl mx-auto space-y-15">
        <div className="flex items-center justify-center pb-10">
          <div
            className="border-b-2 border-[#E0D1ED]"
            style={{ width: "40px" }}
          ></div>
          <h1
            className="font-interMedium mx-4 text-center"
        ...
        <div className="flex flex-wrap">
          <div className="flex flex-col lg:flex-row">
            <div className="basis-full lg:basis-1/2 space-y-10 mb-24">
              <h1
                className="text-left font-inter font-semibold"
                style={{ fontSize: "32px" }}
              >
                For Tufts Students
              </h1>
              <div
                className="text-left space-y-6 text-[#545353]"
                style={{ fontSize: "22px" }}
              >
                <p>
                ...
                <button
                  className="rounded-full bg-[#1E3B68] p-6 text-white text-lg"
                  type="button"
                >
                  Become a Tutor!
                </button>
          ...
          <div className="flex flex-col-reverse lg:flex-row justify-center">
            ...
            <div className="basis-1/2 space-y-10">
              <div className="space-y-6">
                ...
                <p
                  className="text-left text-xl text-[#545353]"
                  style={{ fontSize: "22px" }}
                >
